  ...
  return (
    <section id="contact" className="py-20 bg-blue-900 text-white" ref={sectionRef}>
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="bg-white text-blue-900 rounded-lg shadow-2xl p-8 max-w-lg mx-auto animate-on-scroll">
          <h3 className="text-3xl font-bold mb-2">Juan David Parada Palma</h3>
          <div className="space-y-4 text-xl">
            ...
            <p className="flex items-center justify-center">
              ...
              <a href="mailto:juandavid.ceo@gmail.com" className="hover:text-orange-600 transition-colors">juandavid.ceo@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
