    ...
    <section id="about" className="py-20 bg-white" ref={sectionRef}>
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto text-lg text-gray-700 text-center leading-relaxed animate-on-scroll" style={{ transitionDelay: '200ms' }}>
          <p className="mb-6">
            Somos <span className="font-bold text-blue-900">Biress IHE</span>, una empresa familiar que une la excelencia técnica con una administración moderna y comprometida. En la dirección técnica está <span className="font-semibold">Néstor Rolando Parada Villamil</span>, profesional con más de 35 años de experiencia especializada en mantenimiento hidráulico y electromecánico. Su saber acumulado es la base de cada diagnóstico y solución precisa.
          </p>
          <p className="mb-6">
            Al frente de la gestión está <span className="font-semibold">Juan David Parada Palma</span>, encargado de la atención al cliente, el crecimiento estratégico y la transparencia en cada proceso. Juntos, padre e hijo, ofrecen un servicio técnico de alta calidad, personalizado y confiable.
          </p>
